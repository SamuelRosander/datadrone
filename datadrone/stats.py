...
def get_all(entries, scope_from=None, scope_to=None, days=None):
    ...
    stats["weekday"] = {"Monday": 0, "Tuesday": 0, "Wednesday": 0, "Thursday": 0, "Friday": 0, "Saturday": 0,
                        "Sunday": 0}  # counting how many entries for each day
    stats["time_of_day"] = {"00-04": 0, "04-08": 0, "08-12": 0, "12-16": 0, "16-20": 0,
                            "20-24": 0}  # counting how many entries in each time slot
    ...
    if entries:  # only get stats if there are entries
        ...
        if scope_from and scope_to:
            ...
            stats["total_nr_of_days"] = (now_date - stats["first"].date()).days + 1  # +1 to include current day
